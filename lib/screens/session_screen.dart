...
class _SessionScreenState extends State<SessionScreen> {
        ...
        return ListView(
          ...
          children: [
            ...
            _buildCompactMetricsWrap([
                _buildCompactMetricCard(
                  'Accel / Force',
                  _formatAccelForce(currentAccel, _livePseudoForce),
                  Icons.speed,
                ),
                _buildCompactMetricCard(
                  'Stroke Rate',
        ...
        if (_strokeCountingEnabled) {
          ...
          if (mounted) {
            setState(() {
              ...
              _livePseudoForce = _estimatePseudoForce(
                accelMagnitude: mag,
                strokeRateSpm: _liveSpm,
                totalStrokes: _liveTotalStrokes,
                timeSec: tSec,
                previousForce: _livePseudoForce,
              );
            });
          }
        }
  ...
  void _onHistReplayTick(double timeSec) {
    ...
    setState(() {
      ...
      _dynPseudoForce = _estimatePseudoForce(
